...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
    ...
    S(C(KC_ESC)),  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,             KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_DEL,  KC_BSPC, KC_INS,  KC_PGUP,
    ...
    KC_MPLY,    KC_LCTL, MO(2),   KC_LGUI, KC_LALT, KC_LALT, KC_SPC,                    KC_SPC,  KC_SPC,  KC_RALT, LT(1, KC_RGUI),            KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [1] = LAYOUT_all(
    ...
    KC_SLCK,    KC_CAPS, KC_BTN1, KC_MS_U, KC_BTN2, KC_BTN3, _______,                   _______, _______, _______, _______, KC_PSCR, KC_BRID, KC_BRIU, KC_NLCK, KC_MRWD, KC_MFFD,
